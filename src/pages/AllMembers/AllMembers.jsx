...
const AllMembers = () => {
  ...
  useEffect(() => {
    data.current();
    document.title = "All members - Shilpakanan Phase 3";
  }, []);
  useEffect(() => {
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div
            className={`container container-margin-top ${Styles.allMembersWrapper}`}
          >
                      ...
                      return (
                        <tr key={index} className="count">
                          ...
                          <td
                            className={Styles.r5}
                            onClick={() =>
                              history.push(`/allmembers/${member.publicUrl}`)
                            }
                          >
                            visit
                          </td>
