...
const Register = ({ step }) => {
  ...
  function onProgress() {
    ...
    let dot =
      document.getElementsByClassName("dot")[progress > 2 ? 1 : progress];
    let text =
      document.getElementsByClassName("text")[progress > 2 ? 1 : progress];
  ...
  useEffect(() => {
    document.title = "Register - Shilpakanan Phase 3";
  }, []);
  return (
    <>
      <div
        className={` ${Styles.registerWrapper} container container-margin-top`}
      >
