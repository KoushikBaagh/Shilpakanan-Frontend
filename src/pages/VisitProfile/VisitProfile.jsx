...
const VisitProfile = () => {
  ...
  useEffect(() => {
    document.title = "Member - Shilpakanan Phase 3";
    tempMember.current();
  }, []);
  return loading ? (
        ...
        {!memberData ? (
          ...
          <>
            ...
            >
              <div className={styles.profile}>
                ...
                <div className={styles.info}>
                  ...
                  <p>
                    House No : <span>{memberData.houseNo}</span>
                  </p>
                  <p>
                    Total Members : <span>{memberData.totalMembers}</span>
                  </p>
                  <p className={styles.proffession}>{memberData.proffession}</p>
                  <p style={{ marginBottom: "10px" }}>
                    {memberData.proffessionDiscription}
                  </p>
            ...
            <div className={pStyles.advertiseWrapper}>
              ...
              {!memberData.advertises.length > 0 ? (
                <p style={{ color: "var(--primary-text)", fontWeight: "600" }}>
                  No advertise yet
                </p>
              ) : (
