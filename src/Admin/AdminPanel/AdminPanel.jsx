...
const AdminPanel = () => {
  ...
  async function getData() {
    ...
    setLoading(false);
    document.title = "Admin panel - Shilpakanan Phase 3";
  }
  useEffect(() => {
    getData();
  }, []);
    ...
    <>
      <div className={`${Styles.adminWrapper}`}>
        ...
        <div
          className={
            menuOpen
              ? `${Styles.sidebarWrapper} ${Styles.mobileSidebar}`
        ...
        >
          <div className={Styles.sidebar}>
            ...
            <ul className="adminLinks">
              ...
              <li>
                <i className="fas fa-image"></i>Management
              </li>
              <li>
                <i className="fas fa-frown"></i>Complaine
              </li>
              <li>
